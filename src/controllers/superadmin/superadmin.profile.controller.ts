...
export async function superadminGetMyProfile(
  req: Request,
  res: Response,
  next: NextFunction,
) {
...
export async function superadminUpdateMyProfile(
  req: Request,
  res: Response,
  next: NextFunction,
) {
...
export async function superadminChangeMyPassword(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    const user = await User.findOne({
      where: { id: userId, role: "superadmin", organizationId: orgId },
